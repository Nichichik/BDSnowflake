...
FROM mock_data md
JOIN dim_locations loc ON md.supplier_city = loc.city AND md.supplier_country = loc.country AND loc.postal_code IS NULL;
...
FROM mock_data md
JOIN dim_locations loc ON md.seller_postal_code = loc.postal_code AND md.seller_country = loc.country;
...
FROM mock_data md
JOIN dim_locations loc ON md.store_city = loc.city AND md.store_state = loc.state AND md.store_country = loc.country;
...
FROM mock_data md
JOIN dim_locations loc ON md.customer_postal_code = loc.postal_code AND md.customer_country = loc.country;
